...
setuptools.setup(
    ...
    install_requires=['numpy','qcodes>=0.21.0','matplotlib','scipy','pyvisa-py','resonator_tools @ git+https://github.com/6biscuits/resonator_tools.git', 'ply', 'laboneq', 'laboneq-applications'],
    package_data={
