#
#Adapted FROM: https://raw.githubusercontent.com/QCoDeS/Qcodes_contrib_drivers/main/src/qcodes_contrib_drivers/drivers/QuTech/IVVI.py
...
class VOLT_DelftIVVI(VisaInstrument):
    '''
...
if __name__ == '__main__':
    leVolt = VOLT_DelftIVVI('test', 'ASRL1')
    a=0
