...
class ExpACstarkRamseyGE(Experiment):
    def __init__(self, name, expt_config, cav_drive_power, var_cav_drive_power, wfmt_qubit_drive, range_waits, SPEC_qubit, iq_indices = [0,1], **kwargs):
        super().__init__(name, expt_config)

        self._var_cav_drive_power = var_cav_drive_power
        self.cav_drive_power = cav_drive_power
    ...
    def _run(self, file_path, sweep_vars=[], **kwargs):
        ...
        wfm = WaveformGeneric(['qubit'], ['readout', 'cavity'])
        ...
        wfm.set_digital_segments('cavity', 'qubit', ['wait'])
        ...
        #Set the wait-state cavity-drive power
        self._var_cav_drive_power.Value = self.cav_drive_power
