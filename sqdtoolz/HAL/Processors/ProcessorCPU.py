...
from sqdtoolz.HAL.Processors.CPU.CPU_Variance import*
from sqdtoolz.HAL.Processors.CPU.CPU_MeanVariance import*
...
from sqdtoolz.HAL.Processors.CPU.CPU_Decimation import*
