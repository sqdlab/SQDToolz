...
stz.WaveformAWG("wfm_test", lab, [(['TaborAWG', 'AWG'], 'CH1'), (['TaborAWG', 'AWG'], 'CH2')], 2.0e9)
...
lab.HAL('DDG').get_trigger_output('CD').TrigPulseLength = 50e-9
lab.HAL('DDG').get_trigger_output('CD').TrigPolarity = 1
lab.HAL('DDG').get_trigger_output('CD').TrigPulseDelay = 1.0e-6
lab.HAL('DDG').get_trigger_output('CD').TrigEnable = True ###
